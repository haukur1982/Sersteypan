...
export default async function ProjectsPage() {
    ...
    const projectList = (projects ?? []) as ProjectWithCompany[]
            ...
            <div className="space-y-6">
                ...
                <div className="flex justify-between items-center">
                    <div>
                        ...
                        <p className="text-zinc-600 mt-2">Yfirlit yfir verkefni (Projects Overview)</p>
                    </div>
                        ...
                        <TableBody>
                            {projectList.length > 0 ? (
                                projectList.map((project) => {
                                    // Cast status to keyof typeof statusConfig safely
